  ...
  return (
    <main className="shell py-14 md:py-20">
      <article className="mx-auto max-w-3xl">
        ...
        <Link href="/#generator" className="focus-ring mt-7 inline-flex items-center gap-2 rounded-xl bg-[var(--accent)] px-5 py-3 font-black text-[var(--on-accent)]">Try Roomorphic <ArrowRight size={18} weight="bold" /></Link>
        <AdSlot />
        ...
        <aside className="surface mt-14 p-6 md:p-8"><h2 className="text-3xl font-black tracking-[-0.04em]">See your own room in motion.</h2><p className="mt-3 leading-7 text-[var(--muted)]">Try Roomorphic with a photo or sample room. Your first preview works without login.</p><Link href="/#generator" className="focus-ring mt-6 inline-flex items-center gap-2 rounded-xl bg-[var(--accent)] px-5 py-3 font-black text-[var(--on-accent)]">Try Roomorphic <ArrowRight size={18} weight="bold" /></Link></aside>
      </article>
    </main>
  );
}
