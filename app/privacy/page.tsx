    ...
    <LegalPage title="Privacy Policy" intro="This policy explains how RoomFacelift processes information when you use our AI room-design service. Last updated September 7, 2026.">
      ...
      <section>
        ...
        <ul className="grid list-disc gap-3 pl-6">
          ...
          <li><strong className="text-[var(--ink)]">Creem</strong> acts as Merchant of Record and payment processing provider for purchases made through RoomFacelift where Creem checkout is enabled. Creem handles payment processing, transaction administration, billing-related records, and applicable tax and compliance responsibilities. Payment details are handled by the applicable payment provider or Merchant of Record, and RoomFacelift does not store full payment card information.</li>
